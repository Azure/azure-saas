...
* [**Identity Framework**](components/identity)
  * [**Identity Provider (B2C)**](components/identity/identity-provider/) - An identity solution that provides flexibility for both local accounts and integration with external providers.
